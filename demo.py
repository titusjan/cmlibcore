...
from cmlibcore import ColorLib, ColorLibModel, ColorSelectionWidget, CmLibBrowserDialog
from cmlibcore.qtwidgets.qimg import arrayToQImage
...
def main():
    ...
    data_dir = os.path.abspath("cmlibcore/data")
